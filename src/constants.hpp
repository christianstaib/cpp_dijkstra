...
inline constexpr double meters_per_astronomical_unit = 149597870700.0;

inline constexpr double astronomical_units_per_meter = 1 / meters_per_astronomical_unit;

/// Conversion factor from (m^3)/(Kg*s^2) to (AU^3)/(Kg*d^2)
inline constexpr double m3_per_kg_s2_to_au3_per_kg_d2 =
    (seconds_in_day * seconds_in_day) /
    (meters_per_astronomical_unit * meters_per_astronomical_unit * meters_per_astronomical_unit);
...
inline constexpr double gravitational_constant_in_au3_per_kg_d2 =
    m3_per_kg_s2_to_au3_per_kg_d2 * gravitational_constant_in_m3_per_kg_s2;
...
inline constexpr double softening_factor = 0.0;  // 1e-11;
...
const std::unordered_map<std::string, std::tuple<double, double>> geometric_albedo = {
    {"AMO", {0.450, 0.550}}, {"APO", {0.450, 0.550}}, {"ATE", {0.450, 0.550}}, {"IEO", {0.450, 0.550}},
    {"MCA", {0.450, 0.550}}, {"IMB", {0.030, 0.103}}, {"MBA", {0.097, 0.203}}, {"OMB", {0.197, 0.500}},
    {"CEN", {0.450, 0.750}}, {"TJN", {0.188, 0.124}}, {"TNO", {0.022, 0.130}}, {"AST", {0.450, 0.550}},
